...
1. Team Members: Violet
2. App Name: Meds For Noodles (Work in progress))
3. App Description (3-5 sentences):

This app lets you input the names of your medications. It also allows you to toggle whether or not you've taken them. In the future i hope to be able to add scheduling, alerts, aand graphics for meds, in about that order.
    
4. Your #1 Customer (Who would use your app? Why now?)
 
    People who struggle remembering/ keeping track of their medications/
    
5. Github code repository: https://github.com/violet-love/MedsForNoodles
6. Github Project/Trello Board: https://trello.com/invite/b/6LmHsDgn/49134d0de8b584e0da5f48dfc016a2b6/build-week
...
1.  Feature 1: Input meds and toggle whether or not they've been taken
2.  Feature 2: input schedule with alerts
3.  Feature 3: Pretty med graphics
